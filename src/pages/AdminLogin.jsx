...
export default function AdminLogin() {
  ...
  const onSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await endpoints.adminLogin(email, password);
      navigate('/');
    } catch (err) {
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-forest-700 via-forest-500 to-forest-400 p-4">
      ...
      <div className="relative w-full max-w-sm rounded-card bg-white p-8 shadow-xl">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h2 className="mt-4 text-xl font-bold text-ink-900">Secure Sign In</h2>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="admin@siranaba.com"
          ...
          >
            {submitting ? 'Signing in…' : 'Authorized Sign In'} <Icon name="chevronRight" size={15} />
          </button>
        </form>
